...
<option name="choose_one" <?php if($choose_one=="Sosial Masyarakat"){echo "selected";}?> value="Sosial Masyarakat">Sosial Masyarakat</option>
...
<option name="choose_one" <?php if($choose_one=="Olahraga dan Seni Budaya"){echo "selected";}?> value="Olahraga">Olahraga dan Seni Budaya</option>
