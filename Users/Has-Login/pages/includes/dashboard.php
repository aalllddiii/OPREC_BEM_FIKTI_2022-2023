<div class="row">
    ...
    <div class="col-lg-2 col-md-4 col-6 stretch-card grid-margin">
        <div class="card" style="background-color: unset !important;">
            <div class="card-body" style="padding: 0px !important; ">
                ...
                <h4 class="text-center text-list-logo pt-0">Sosial Masyarakat</h4>
            </div>
        </div>
    </div>
    <div class="col-lg-2 col-md-4 col-6 stretch-card grid-margin">
    ...
    <div class="col-lg-2 col-md-4 col-6 stretch-card grid-margin">
        <div class="card" style="background-color: unset !important;">
            <div class="card-body" style="padding: 0px !important; ">
                <a href=""><img src="../assets/images/Olahraga dan Seni Budaya.png" alt="" class="img-fluid"></a>
                <h4 class="text-center text-list-logo pt-0">Olahraga dan Seni Budaya</h4>
            </div>
        </div>
    </div>
    <div class="col-lg-2 col-md-4 col-6 stretch-card grid-margin">
