    ...
    <div class="card-header" style="padding: 0px;">
        <h5 class="mb-0">
            <a class="btn" data-toggle="collapse" href="#BidangMIB" role="button" aria-expanded="true"
                aria-controls="BidangMIB" style="color: #723d90;">Bidang Manajemen Informasi & Bisnis</a>
        </h5>
    </div>
    <div class="row">
        <div class="col">
                    ...
                    <div class="card mb-2">
                        ...
                        <div id="Media" class="collapse" aria-labelledby="BiroMedia" data-parent="#accordion">
                            <div class="row">
                                ...
                                Biro media berperan dalam desain dan videography yang membantu konsep komunikasi dan ungkapan kreatif, 
                                teknik dan media dengan memanfaatkan elemen-elemen visual ataupun rupa untuk menyampaikan pesan dan tujuan tertentu di dalam BEM FIKTI UG kepada mahasiswa FIKTI Universitas Gunadarma.
                                    <hr class="col-10">
                    ...
                    <div class="card mb-2">
                        ...
                        <div id="Humas" class="collapse" aria-labelledby="BiroHumas" data-parent="#accordion">
                            <div class="row">
                                ...
                                <div class="col-md-8 card-body deskripsi-dept-biro">
                                Biro Humas (Hubungan Masyarakat) bertanggung jawab untuk melakukan publikasi,
                                menjaga relasi eksternal BEM FIKTI UG, dan menjadi garda terdepan untuk citra BEM FIKTI UG. 
                                Biro Humas berperan aktif dalam mewakilkan suara BEM FIKTI UG melalui media sosial untuk menciptakan BEM FIKTI UG yang informatif.
                                    <hr class="col-10">
                                    <span class="text-muted" style="font-style: italic;">
                    ...
                    <div class="card mb-2">
                        ...
                        <div id="PTI" class="collapse" aria-labelledby="BiroPTI" data-parent="#accordion">
                            <div class="row">
                                ...
                                <div class="col-md-8 card-body deskripsi-dept-biro">
                                Biro PTI (Pengembangan Teknologi Informasi) berperan untuk mengembangan teknologi informasi dalam BEM FIKTI UG 
                                dan membantu program kerja yang ada di BEM FIKTI UG khususnya dalam pembuatan website untuk program kerja.
                                    <hr class="col-10">
                                    <span class="text-muted" style="font-style: italic;">
                    ...
                    <div class="card mb-2">
                        ...
                        <div id="Bismit" class="collapse" aria-labelledby="BiroBismit" data-parent="#accordion">
                            <div class="row">
                                ...
                                <div class="col-md-8 card-body deskripsi-dept-biro">
                                Biro BISMIT (Bisnis dan Kemitraan) merupakan biro yang berfungsi sebagai pilar penunjang
                                perekonomian BEM FIKTI UG dengan cara menjual produk berupa merchandise kepada
                                mahasiswa FIKTI Universitas Gunadarma serta membantu program kerja BEM FIKTI UG 
                                dalam hal pengadaan barang penunjang program kerja/acara
                                    <hr class="col-10">
                                    <span class="text-muted" style="font-style: italic;">
