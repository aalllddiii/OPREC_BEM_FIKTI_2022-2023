                                ...
                                <div class="card bg-gradient-danger card-img-holder text-white"
                                    ...
                                    <div class="card-body" style="border-radius: 20px !important;">
                                        <center>
                                            <h1>TIDAK LOLOS</h1>
                                            <br><br>
                                            <h2>Mohon maaf  <?= $_SESSION['nama_lengkap']; ?> <br> Anda belum bisa bergabung menjadi bagian dari keluarga BEM FIKTI UG periode 2022/2023. 
                                ...
                                <div class="card bg-gradient-info card-img-holder text-white"
                                    ...
                                    <div class="card-body" style="border-radius: 20px !important;">
                                        <center>
                                            ...
                                            <h2>anda telah lulus seleksi final oprec 2022</h2>
                                            <img src="../../../../images_calon/<?php echo $pas_foto; ?>" alt="image"
